...
import { useCreateTermsAndConditionsMutation, useGetTermsAndConditionsQuery } from "../../../Redux/features/settingApi";

const PrivacyPolicy = () => {
  const editor = useRef(null);
  const [content, setContent] = useState("");
  const { data, isSuccess } = useGetTermsAndConditionsQuery();
  ...
  const [createPrivacyPolicy] = useCreateTermsAndConditionsMutation();

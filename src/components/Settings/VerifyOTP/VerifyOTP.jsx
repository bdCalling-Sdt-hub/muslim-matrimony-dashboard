    ...
    <div className=" p-5">
      <form className="w-[750px]">
        ...
        <div className="flex justify-between mt-5">
          ...
          <p
            className="text-siteColor text-lg font-semibold cursor-pointer 
          "
        ...
        <button
          type="submit"
          onClick={handleOtp}
          className="bg-siteColor w-full text-white font-semibold rounded-md flex justify-center mx-auto px-[100px] mt-10 py-3"
        >
          Verify
        </button>
      </form>
